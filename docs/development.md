...
Операционный процесс, когда необходимость изменения обнаружена во время задачи
в consumer-проекте, включая явное разрешение на cross-repository правки,
совместимость и Definition of Done, описан в
[`MAINTAINING.md`](../MAINTAINING.md). Эта страница содержит технические команды
локальной проверки и выпуска.
